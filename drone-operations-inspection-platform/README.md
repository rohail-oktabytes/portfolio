...
> 📄 **Client-facing case study (C-S-R):** [`drone-operations-inspection-platform_case_study.pdf`](drone-operations-inspection-platform_case_study.pdf) — a polished, shareable PDF with Challenge → Solution → Result, embedded screenshots (logos redacted).
